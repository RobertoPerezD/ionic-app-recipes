...
@Component({
  selector: 'app-pastas-detalle',
  templateUrl: './pastas-detalle.component.html',
  styleUrls: ['./pastas-detalle.component.scss'],
})
export class PastasDetalleComponent implements OnInit {
  public title: string; 
  public img: string;
